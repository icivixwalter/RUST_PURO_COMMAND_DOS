...
// @02=Funzione per i sottomenu
  #[warn(unused_must_use)]
    fn sub_menu(sub_menu: &str) {

        //pulisco lo schermo
            clear_screen();
        loop {
            println!("SOTTOMENU {}",                sub_menu);
            println!("0. Salva {}",                 sub_menu);
            println!("1. Visualizza {}",            sub_menu);
            println!("2. Salvataggi dei dati {}",   sub_menu);
            println!("3. Cancella DATI {}",         sub_menu);
            ...
            match choice.trim() {
                ...
                "0" => {
                    ...
                    clear_screen();
                    println!("Tornando al SOTTOMENU {}", sub_menu);
                },
                ...
                //2 = SALVATAGGIO DATI + ritardo + ritorno sottomenu
                    "2" => {
                        ...
                        println!("Torno al SOTTOMENU {}", sub_menu);
                        thread::sleep(Duration::from_secs(1)); // Ritardo di 2 secondi
                    }
                ...
                //3 = CANCELLA DATI + ritardo + ritorno sottomenu
                    "3" => {
                        ...
                        let _ = explorer::lib_explorer::delete_files(clear_screen); // Chiamata alla funzione passando clear_screen come parametro
                ...
                _ => {
                    println!("SCELTA ERRATA NEL SOTTOMENU {}. RIPROVA.", sub_menu);
                    thread::sleep(Duration::from_secs(1)); // Ritardo di 5 secondi
                    //@cls.02 _(chiamo la procedura)
                    clear_screen();
                }
